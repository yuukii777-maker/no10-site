...
export default function AboutClient() {
  ...
  return (
    <main className="pt-20 text-[#333]">
      ...
      {/* 🔶 ヒーロー */}
      {/* ============================= */}
      <section className="relative w-full h-[70vh] overflow-hidden bg-black fade-in">
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 py-16 fade-in">
        ...
        <div className="mt-10 overflow-hidden rounded-xl shadow-lg slider">
          <div className="slide-track">
            <Image src="/mikan/farm.png" width={1600} height={900} alt="農園" className="slide-img" />
            <Image src="/mikan/hand.png" width={1600} height={900} alt="収穫" className="slide-img" />
            <Image src="/mikan/premium.png" width={1600} height={900} alt="品質" className="slide-img" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 py-12 fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 mt-12">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 text-center border hover:shadow-xl transition fade-in">
            <Image src="/mikan/premium.png" alt="品質" width={180} height={180} className="mx-auto rounded-lg" />
            <h3 className="text-lg md:text-xl font-semibold mt-6">甘み・香りのバランス</h3>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 text-center border hover:shadow-xl transition fade-in">
            <Image src="/mikan/hand.png" alt="収穫" width={180} height={180} className="mx-auto rounded-lg" />
            <h3 className="text-lg md:text-xl font-semibold mt-6">ひとつひとつ手作業</h3>
            <p className="text-gray-600 mt-3 leading-relaxed text-sm md:text-base">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 text-center border hover:shadow-xl transition fade-in">
            <Image src="/mikan/defect.png" alt="訳あり" width={180} height={180} className="mx-auto rounded-lg" />
            <h3 className="text-lg md:text-xl font-semibold mt-6">訳あり100円の理由</h3>
            <p className="text-gray-600 mt-3 leading-relaxed text-sm md:text-base">
